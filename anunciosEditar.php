...
<div class="layout">
  <div class="componente">
    <div class="componente__encabezado">
      <h2 class="componente__titulo">Anuncios Publicados</h2>
      <button class="componente__boton-subir"><a href="./formularioAnuncio.php"> Publicar Nuevo Anuncio</a></button>
    </div>
      ...
      <table class="componente__tabla">
        ...
        <tbody>
          ...
          <tr class="componente__fila">
            ...
            <td class="componente__celda">Breve descripción del anuncio 1...</td>
          ...
          <tr class="componente__fila">
            ...
            <td class="componente__celda">Breve descripción del anuncio 2...</td>
